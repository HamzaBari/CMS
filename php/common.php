...
function outputBannerNavigation($pageName){
    ...
    echo '<div class="header">Content Managment System</div>';
    echo '<div class="navigation">';
    
    //Array of pages to link to
    $linkNames = array("Home", "View and Add", "View and Delete orders");
    $linkAddresses = array("Home.php", "View and Add.php", "View and Delete orders.php");
